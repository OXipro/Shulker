...
dependencyResolutionManagement {
    versionCatalogs {
        create("libs") {
            ...
            version("kubernetes-client", "7.4.0")
            version("grpc", "1.77.0")
            ...
            library("adventure-text-serializer-gson", "net.kyori:adventure-text-serializer-gson:4.26.1")
            ...
            library("grpc-common-protos", "com.google.api.grpc:proto-google-common-protos:2.72.0")
